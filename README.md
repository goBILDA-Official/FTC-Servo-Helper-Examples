...
## Installing OpModes in Android Studio:
...
## Installing OpModes in Onbot Java
Navigate to the OnBot Java tab of your Robot Controller either by using the REV Hardware Interface and a USB A to C cable, or by connecting to the Robot Controller’s wifi network and going to
192.168.43.1:8080 in the browser of your choice. Before clicking the upload button and uploading
one or both files one-at-a-time.
